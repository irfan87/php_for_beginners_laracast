	...
	<div class="min-h-full">
					...
					<div class="flex items-center">
						...
						<div class="hidden md:block">
							<div class="ml-10 flex items-baseline space-x-4">
								...
								<a href="/demo/" class="px-3 py-2 text-sm font-medium text-white" aria-current="page">Home</a>
								<a href="/demo/about.php"
									class="bg-gray-900 text-white rounded-md text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">About
									Us</a>
		...
		<main>
			<div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
				<h2 class="font-lg">You are now at the about page!</h2>
			</div>
		</main>
	</div>
